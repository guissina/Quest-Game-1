...
public record PlayerStateDTO(
        ...
        public static PlayerStateDTO from(PlayerState state, boolean isCurrentTurn) {
                ...
                String pendingEffect = state.getPendingAbilityEffect() != null
                                ? state.getPendingAbilityEffect().name()
                                : null;
                return new PlayerStateDTO(
                                ...
                                state.getTokens(),
                                isCurrentTurn,
                                state.getPendingQuestion() != null
                                                ? QuestionResponseDTO.from(state.getPendingQuestion())
                                                : null,
