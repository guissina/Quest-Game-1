...
import com.quest.dto.rest.Theme.ThemeAvailabilityDTO;
...
public class ThemeController {
    ...
    // TODO: Verificar necessidade de ignorar o campo "free" no update
    @PatchMapping("/{id}/availability")
    @Operation(summary = "Update theme availability")
    public ResponseEntity<ThemeResponseDTO> updateThemeAvailability(@PathVariable long id,
            @RequestBody ThemeAvailabilityDTO themeAvailabilityDTO) {
        ThemeResponseDTO updatedTheme = themeServices.updateThemeAvailability(id, themeAvailabilityDTO.getFree());
        return ResponseEntity.ok(updatedTheme);
    }
