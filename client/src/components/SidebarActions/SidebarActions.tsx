...
export default function SidebarActions({ myState, currentPlayerId, myPlayerId, onConfirmMove, onUseAbility }: SidebarActionsProps) {
            ...
            <div className={styles.section}>
                ...
                <div className={styles.moveTokens}>
                    {myState.tokens.map(t => (
                        <button key={t} className={styles.moveToken} onClick={() => onConfirmMove(t)}>
                            {t}
                        </button>
                    ))}
                </div>
                ...
                <div className={styles.abilities}>
                    {myState.getAllAbilities().map(a => {
                        ...
                        return (
                            <button
                                key={a}
                                className={`${styles.abilityBtn} ${active ? styles.active : styles.inactive}`}
